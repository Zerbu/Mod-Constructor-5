...
namespace Constructor5.Elements.SituationGoals.Components
{
    ...
    [HasAutoEditor("These conditions must pass for the goal to be selected from a goal set or whim set.")]
    public class SituationGoalPreConditionsComponent : SituationGoalComponent
    {
        public override string ComponentLabel => "Availability Conditions";
