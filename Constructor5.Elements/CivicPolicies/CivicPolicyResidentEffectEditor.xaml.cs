...
{
    [ObjectEditor(typeof(CivicPolicyResidentEffect))]
    public partial class CivicPolicyResidentEffectEditor : UserControl, IObjectEditor
    {
        public CivicPolicyResidentEffectEditor() => InitializeComponent();
